...
return [
    ...
    */
    ...
    'custom' => [
        'username' => [
            'required' => 'نام کاربری به درستی وارد نشده',
            'min' => [
                'numeric' => 'نام کاربری حداقل باید :min کاراکتر باشد.',
            ]
        ],
        'firstname' => [
            'required' => 'نام شخص وارد نشده است.',
            'min' => [
                'numeric' => 'نام شخص حداقل باید :min کاراکتر باشد.',
            ]
        ],
        'lastname' => [
            'required' => 'نام خانوادگی شخص وارد نشده است.',
            'min' => [
                'numeric' => 'نام خانوادگی شخص حداقل باید :min کاراکتر باشد.',
            ]
        ],
        'bio' => [
            'required' => 'فیلد بیوگرافی وارد نشده است.',
            'min' => [
